...
const stripePromise = loadStripe("pk_test_51abc123..."); // 🔑 tu clave pública
...
export default function PaginaProductos() {
  ...
  const [limiteProductos, setLimiteProductos] = useState(10); // ← muestra inicial
